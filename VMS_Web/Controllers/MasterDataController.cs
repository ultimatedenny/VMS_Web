...
namespace VMS.Web.Controllers
{
    ...
    public class MasterDataController : Controller
    {
        ...
        {
            return Json(_mdAction.GetApproverforDDList(""), JsonRequestBehavior.AllowGet);
        }
        public JsonResult getApproverList2()
        {
            return Json(_mdAction.GetApproverforDDList2(""), JsonRequestBehavior.AllowGet);
        }
        public JsonResult getApproverList3(string dept, string plant)
        {
            return Json(_mdAction.GetApproverforDDList3(dept, plant), JsonRequestBehavior.AllowGet);
        }
